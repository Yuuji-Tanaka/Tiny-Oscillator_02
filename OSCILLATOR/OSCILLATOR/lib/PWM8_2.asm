...
;  Global Symbols
;-----------------------------------------------
export  PWM8_2_EnableInt
export _PWM8_2_EnableInt
export  PWM8_2_DisableInt
export _PWM8_2_DisableInt
export  PWM8_2_Start
export _PWM8_2_Start
export  PWM8_2_Stop
export _PWM8_2_Stop
export  PWM8_2_WritePeriod
export _PWM8_2_WritePeriod
export  PWM8_2_WritePulseWidth
export _PWM8_2_WritePulseWidth
export  PWM8_2_bReadPulseWidth
export _PWM8_2_bReadPulseWidth
export  PWM8_2_bReadCounter
export _PWM8_2_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_2_ReadPulseWidth    ; deprecated
export _bPWM8_2_ReadPulseWidth    ; deprecated
export  bPWM8_2_ReadCounter       ; deprecated
export _bPWM8_2_ReadCounter       ; deprecated


AREA osilator_8_2_RAM (RAM,REL)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_2_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_2_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_2_WritePeriod
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_2_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_2_WritePulseWidth:
_PWM8_2_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_2_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_2_bReadPulseWidth:
_PWM8_2_bReadPulseWidth:
 bPWM8_2_ReadPulseWidth:                         ; this name deprecated
_bPWM8_2_ReadPulseWidth:                         ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_2_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_2_bReadCounter
;
;  DESCRIPTION:
...
;
 PWM8_2_bReadCounter:
_PWM8_2_bReadCounter:
 bPWM8_2_ReadCounter:                            ; this name deprecated
_bPWM8_2_ReadCounter:                            ; this name deprecated
   ...
   mov   A, reg[PWM8_2_COMPARE_REG]              ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_2_Stop_M                                 ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_2_INPUT_REG]                ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_2_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_2_COUNTER_REG]              ; DR2 <- DR0
   mov   A, reg[PWM8_2_COMPARE_REG]              ; Stash the Count on the stack
   ...
   mov   reg[PWM8_2_INPUT_REG], A                ;
   M8C_SetBank0                                  ;
   PWM8_2_Start_M                                ;   then re-enable the PWM.
