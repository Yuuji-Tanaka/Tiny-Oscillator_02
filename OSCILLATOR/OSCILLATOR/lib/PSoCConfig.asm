...
export LoadConfig_osilator_8_2
export _LoadConfig_osilator_8_2
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_osilator_8_2
	lcall	LoadConfigTBL_osilator_8_2_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration osilator_8_2
;
;    Load configuration registers for osilator_8_2.
...
;               CUR_PP
;
_LoadConfig_osilator_8_2:
 LoadConfig_osilator_8_2:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_osilator_8_2_Bank0
    mov     X, <LoadConfigTBL_osilator_8_2_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_osilator_8_2_Bank1
    mov     X, <LoadConfigTBL_osilator_8_2_Bank1
